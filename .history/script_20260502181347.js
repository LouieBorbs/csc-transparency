...
renderHeader: function(user) {
    ...
    renderStudentSidebar: function() {
        ...
        '<button class="btn btn-primary btn-sm" id="chatbot-send" style="margin-top:8px;"><i class="fas fa-paper-plane"></i> Send</button>' +
        '</div></div></div>' +
        // QR Scan Modal moved to sidebar to be globally accessible on student dashboard
        '<div id="qr-scan-modal" class="modal" style="display:none;align-items:center;justify-content:center;z-index:9999;">' +
            ...
            '<p style="font-size:12px;margin:0;"><strong>User:</strong> ' + this.currentUser.name + '</p></div>' +
