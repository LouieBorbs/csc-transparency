    ...
    renderAdminAttendance: function() {
        ...
        if (qrCodesList.length === 0) {
            ...
            qrCodesList.forEach(function(q) {
                ...
                '<td><button class="btn btn-sm btn-warning" data-action="view-qr-code" data-id="' + q.id + '" data-url="' + encodeURIComponent(qrUrl) + '"><i class="fas fa-qrcode"></i> View</button> ' +
                '<button class="btn btn-sm btn-secondary" data-action="edit-qr-code" data-id="' + q.id + '"><i class="fas fa-edit"></i> Edit</button> ' +
                '<button class="btn btn-sm btn-danger" data-action="delete-qr-code" data-id="' + q.id + '"><i class="fas fa-trash"></i> Delete</button> ' +
                '<button class="btn btn-sm btn-info" data-action="view-qr-attendees" data-id="' + q.id + '"><i class="fas fa-users"></i> Attendees</button> ' +
